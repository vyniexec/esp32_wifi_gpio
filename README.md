...
O projeto contém um arquivo em linguagem C [main.c](main/main.c) e outros arquivos como o [acio_rele.c](main/acionamento_rele/acio_rele.c) e também o [wifi.c](main/wifi/wifi.c). O arquivo está na pasta [main](main).
